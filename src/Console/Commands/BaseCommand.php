...
abstract class BaseCommand extends Command
{
     ...
     *
     * @param string $stubName The name of the stub file to render (e.g. 'controller.stub')
     ...
     *
     * @throws RuntimeException If the stub file is not found in either the host or package location
     */
    protected function render(string $stubName, array $vars): string
    {
        return $this->renderer->render($this->readStub($stubName), $vars);
    }
